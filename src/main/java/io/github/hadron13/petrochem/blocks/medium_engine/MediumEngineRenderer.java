...
public class MediumEngineRenderer extends SafeBlockEntityRenderer<MediumEngineBlockEntity> {


    public MediumEngineRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    protected void renderSafe(MediumEngineBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource bufferSource, int light, int overlay) {
        ...
        transformed(PetrochemPartialModels.MEDIUM_PISTON, blockState, facing, roll90)
                .translate(0, piston + 20/16f, 0)
                .light(light)
                .renderInto(ms, vb);

        transformed(PetrochemPartialModels.MEDIUM_ENGINE_LINKAGE, blockState, facing, roll90)
                .center()
                .translate(0, 1, 0)
                .uncenter()
                .translate(0, piston + 20/16f, 0)
        ...
        transformed(PetrochemPartialModels.MEDIUM_ENGINE_CONNECTOR, blockState, facing, roll90)
                .translate(0, 2, 0)
                .center()
